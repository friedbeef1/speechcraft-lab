...
export function FlippableResourceCard({ title, description, category, icon: Icon, tips }: FlippableResourceCardProps) {
  ...
  return (
    ...
    >
      <div className={`relative h-[280px] sm:h-[300px] transform-style-3d transition-all duration-500 ${
        isFlipped ? "rotate-y-180" : ""
      }`}>
        {/* Front of card */}
        <Card
          className="absolute inset-0 glass-medium shadow-glass hover:glass-light backface-hidden"
        >
          <CardHeader>
