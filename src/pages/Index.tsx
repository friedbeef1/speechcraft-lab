...
import { Plus, Edit, Trash2, Briefcase, Users, Heart, Mic, Presentation, Phone, UserCheck, Coffee, MessageSquare, Pencil } from "lucide-react";
        ...
        <CardContent className="p-4 sm:p-6">
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="social">
              ...
              <AccordionContent>
                <div className="space-y-2 pt-2 sm:pt-4">
                  {prebuiltScenarios.social.map(scenario => <button key={scenario.id} onClick={() => handleStartScenario(scenario.title)} className="w-full flex items-start gap-2 sm:gap-4 p-3 sm:p-4 rounded-lg border border-border/50 glass-ultralight backdrop-blur-md hover:glass-light hover:shadow-glass transition-smooth text-left hover:scale-[1.01]">
                      <div className="p-1.5 sm:p-2 rounded-lg glass-medium backdrop-blur-md flex-shrink-0">
                        <scenario.icon className="h-4 w-4 sm:h-5 sm:w-5" />
                      </div>
                      <div className="flex-1 min-w-0">
            ...
            <AccordionItem value="love">
              ...
              <AccordionContent>
                <div className="space-y-2 pt-2 sm:pt-4">
                  {prebuiltScenarios.love.map(scenario => <button key={scenario.id} onClick={() => handleStartScenario(scenario.title)} className="w-full flex items-start gap-2 sm:gap-4 p-3 sm:p-4 rounded-lg border border-border/50 glass-ultralight backdrop-blur-md hover:glass-light hover:shadow-glass transition-smooth text-left hover:scale-[1.01]">
                      <div className="p-1.5 sm:p-2 rounded-lg glass-medium backdrop-blur-md flex-shrink-0">
                        <scenario.icon className="h-4 w-4 sm:h-5 sm:w-5" />
                      </div>
                      <div className="flex-1 min-w-0">
